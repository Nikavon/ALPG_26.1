...
tentativas_login = int(input("Digite o número de tentativas de login falhas: ")) 
dispositivo = int(input("Você tentou acessar de um dispositivo não reconhecido?:\n1 - SIM \n2 - NÃO\n"))

if tentativas_login >= 3 or dispositivo == 1:
